...
function handleMIDINoteOn(note, velocity, channel) {
    ...
    // Play the instrument at the exact MIDI note (chromatic, full range)
    ...
    // Use playInstrumentMIDI for chromatic note playback
    synth.playInstrumentMIDI(instrument, note);
    
    // Restore original volume
    synth.instrumentVolumes[instrument] = originalVolume;
    
    // Flash the nearest UI element for visual feedback
